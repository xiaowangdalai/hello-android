...
public class SlidingMenuLayout extends HorizontalScrollView {
	...
	public SlidingMenuLayout(Context context, AttributeSet attrs, int defStyleAttr) {
		...
		TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.SlidingMenuLayout);
		mMenuRightPadding = ta.getDimensionPixelSize(R.styleable.SlidingMenuLayout_manuRightPadding
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		if (!init) {
			...
			mMenuWidth = menu.getLayoutParams().width = mScreenWidth - mMenuRightPadding;
